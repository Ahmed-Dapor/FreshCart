 ...
 let navigate = useNavigate()
  ...
  return <>
    ...
    <div className='pt-8 w-1/2 mx-auto'>
      <h1 className='py-5 text-3xl font-semibold'>Login Now :</h1>
     ...
     {apiError &&  <div className="p-2 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-red-200 dark:text-red-800" role="alert">
        ...
        </button> :        <button type="submit" className="text-white bg-emerald-500 hover:bg-emerald-500 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">Login</button>
      }
